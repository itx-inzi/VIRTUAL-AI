...
// DATA
let yourName = (localStorage.getItem('yourName') != null)? localStorage.getItem('yourName') : 'inzi';
yourNameInput.value = yourName;
let herName = (localStorage.getItem('herName') != null)? localStorage.getItem('herName') : 'nimo';
    ...
    data = [
        {
            ...
            ans         :   ['Hi Babe', 'Hi Sweetheart', 'Hi Babu', `Hi ${yourName}`, 'Hello Babe', 'Hello Sweetheart', 'Hello Babu', 'Hey', 'Hey Babe', 'Hey Sweetheart', 'Hey Babu', 'Whatsup', 'Whatsup Babe', 'Whatsup Sweetheart', 'Whatsup Babu']
        },
        {
            title       :   'Propose',
            questions   :   ['I Love You', 'Love You'],
            ans         :   ['I Love You Too', 'ummahh inzo', 'Love You Sweetheart'],
        },
        {
            title       :   'Her Name',
